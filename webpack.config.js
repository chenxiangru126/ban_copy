    ...
    proxy: {
      '/admin/*': {
        ...
        // target: 'http://192.168.3.40:8080',
            target: 'http://test.bjyishubiyeji.com:8080',//测试站
        //  target: 'https://yddwechat.bjyishubiyeji.com:8443',//正式站
      ...
      '/mall/*': {
          target: 'http://test.bjyishubiyeji.com',//测试站
          // target:'http://yddwechat.bjyishubiyeji.com',//正式站
        changeOrigin: true,
        secure: false
      } ,
    }
